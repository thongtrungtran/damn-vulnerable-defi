...
describe("[Challenge] Truster", function () {
  ...
  it("Exploit", async function () {
    ...
    const TrusterAttacker = await ethers.getContractFactory("TrusterAttacker");
    this.attackerContract = await TrusterAttacker.deploy();

    await this.attackerContract
      .connect(attacker)
      .exploit(this.pool.address, this.token.address);
  });
